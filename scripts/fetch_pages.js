...
const urls = [
  'http://localhost:3000/dashboard/encounters/new?patientId=patient-001',
  'http://localhost:3000/dashboard/encounters/new?patientId=patient-002',
  'http://localhost:3000/dashboard/encounters/new?patientId=patient-003',
  'http://localhost:3000/dashboard/prescriptions/new?patientId=patient-001',
];
