# S-003 — User can view triage history after login

**Epic:** E-001
**Priority:** Medium
**Status:** not-started
**Assigned:** Amelia
**FHIR Resources:** ClinicalImpression, Encounter
...
I want to **view a list of my past triage sessions**,
so that **I can track how my condition has changed over time**.
