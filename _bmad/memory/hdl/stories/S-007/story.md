# S-007 — User can enter optional symptom text to supplement camera image
...
As a **patient**,
I want to **type a brief symptom description alongside my camera capture**,
so that **the AI has more context and gives a more accurate triage result**.
