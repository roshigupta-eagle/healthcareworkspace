# S-020 — User can view list of past triage encounters in-app

**Epic:** E-008
**Priority:** Medium
**Status:** not-started
**Assigned:** Amelia
**FHIR Resources:** Encounter, ClinicalImpression (read)
...
As a **patient**,
I want to **see a timeline of my past triage sessions in the app**,
so that **I can track my health history and share it with my doctor**.
