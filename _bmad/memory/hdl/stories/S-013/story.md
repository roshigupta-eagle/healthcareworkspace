# S-013 — User sees home remedy instructions for non-urgent pathways

**Epic:** E-005
**Priority:** Medium
**Status:** not-started
**Assigned:** Amelia
**FHIR Resources:** Communication (read)
...
As a **patient**,
I want to **receive safe, specific home care instructions when my condition is non-urgent**,
so that **I can treat myself at home without an unnecessary doctor visit**.
