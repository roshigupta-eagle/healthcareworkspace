# S-015 — System creates FHIR Patient, Encounter, Media, Observation on triage start

**Epic:** E-006
**Priority:** Medium
**Status:** not-started
**Assigned:** Amelia
**FHIR Resources:** Patient, Encounter, Media, Observation
...
As a **system**,
I want to **atomically create all prerequisite FHIR resources when a triage session starts**,
so that **the triage result has a complete and auditable FHIR resource chain**.
