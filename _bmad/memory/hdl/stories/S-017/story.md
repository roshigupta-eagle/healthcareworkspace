# S-017 — FHIR resources validate against HealthTriage CA Core profiles
...
As a **system**,
I want to **validate all created FHIR resources against their HealthTriage profiles before committing**,
so that **only conformant resources are stored and interoperability is guaranteed**.
