...
export const semanticColors = {
  action: {
    ...
    primaryMuted: colorPalette.primary[100],
    danger:       colorPalette.critical[600],
    dangerHover:  colorPalette.critical[700],
  },
  status: {
    critical: colorPalette.critical[600],
    warning:  colorPalette.warning[600],
    stable:   colorPalette.stable[600],
  ...
  text: {
    ...
    critical:  colorPalette.critical[700],
    warning:   colorPalette.warning[700],
    stable:    colorPalette.stable[700],
    info:      colorPalette.info[700],
  },
  background: {
    page:        colorPalette.neutral[50],
    surface:     '#ffffff',
    subtle:      colorPalette.neutral[100],
    inverted:    colorPalette.neutral[900],
    criticalMuted: colorPalette.critical[50],
    warningMuted:  colorPalette.warning[50],
    stableMuted:   colorPalette.stable[50],
    infoMuted:     colorPalette.info[50],
  },
  border: {
    ...
    critical: colorPalette.critical[400],
    warning:  colorPalette.warning[400],
    stable:   colorPalette.stable[400],
  },
} as const;

export type ColorScale  = typeof colorPalette;
