...
exports.progressIndicationRules = exports.safeDefaultRules = exports.errorRecoveryRules = exports.confirmationRules = exports.componentSelectionGuide = exports.spacingRules = exports.typographyRules = exports.colorUsageRules = exports.corePrinciples = void 0;
/**
 * The seven immutable principles of the HealthOS design system.
 * No component or pattern may violate these.
 */
exports.corePrinciples = [
    {
        id: 1,
        name: 'Safety First',
        statement: 'Clinical risk information (allergies, critical values, isolation precautions) ' +
    ...
    },
    {
        ...
        statement: 'Clinical workflows happen under time pressure and interruption. Every screen ' +
    ...
    },
    {
        ...
        statement: 'Actions that cannot be undone — discontinuing a medication, discharging a ' +
    ...
    },
    {
        ...
        statement: 'UI copy uses the same clinical terminology as the underlying FHIR resources. ' +
    ...
    },
    {
        ...
        statement: 'WCAG 2.1 AA is the minimum bar for every component. Touch targets, contrast, ' +
    ...
    },
    {
        ...
        statement: 'Slow UIs cost clinical time. Components optimise for fast first-paint, minimal ' +
    ...
    },
    {
        ...
        statement: 'Every significant clinical action is traceable. Components that perform ' +
 ...
 */
exports.componentSelectionGuide = {
    feedbackMessages: {
...
// ─────────────────────────────────────────────────────────────────────────────
exports.progressIndicationRules = {
    immediateLoading: {
