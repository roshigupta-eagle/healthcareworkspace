...
exports.mockUsers = exports.mockQueueItems = exports.mockRooms = exports.mockVisits = void 0;
...
const mockUsers = {
    'user-dr-chen': {
        ...
        tenantId: 'default',
        name: 'Dr. Alice Chen',
        role: fhir_domain_1.CardiologyRole.CARDIOLOGIST,
    ...
    'user-nurse-patel': {
        ...
        role: fhir_domain_1.CardiologyRole.NURSE,
    ...
    'user-receptionist-davis': {
        ...
        role: fhir_domain_1.CardiologyRole.RECEPTIONIST,
    ...
    'user-tech-lee': {
        ...
        role: fhir_domain_1.CardiologyRole.TECHNICIAN,
    ...
    'user-billing-garcia': {
        ...
        role: fhir_domain_1.CardiologyRole.BILLING,
    ...
    'user-admin-khan': {
        ...
        role: fhir_domain_1.CardiologyRole.ADMIN,
...
const mockVisits = [
    {
        ...
        currentState: fhir_domain_1.CardiovascularVisitState.IN_WAITING_ROOM,
        priority: fhir_domain_1.VisitPriority.URGENT,
    ...
    },
    {
        ...
        currentState: fhir_domain_1.CardiovascularVisitState.NURSING_ASSESSMENT,
        priority: fhir_domain_1.VisitPriority.NORMAL,
    ...
    },
    {
        ...
        currentState: fhir_domain_1.CardiovascularVisitState.PROCEDURE_QUEUED,
        priority: fhir_domain_1.VisitPriority.NORMAL,
        ...
        proceduresOrdered: [
            {
                id: 'proc-001',
                visitId: 'visit-003',
                procedureType: fhir_domain_1.CardiovascularProcedureType.ECHO,
                status: fhir_domain_1.ProcedureStatus.QUEUED,
                orderedBy: 'Dr. Chen',
    ...
    },
    {
        ...
        currentState: fhir_domain_1.CardiovascularVisitState.REFERRAL_RECEIVED,
        priority: fhir_domain_1.VisitPriority.HIGH,
        arrivedAt: undefined,
        isNewPatient: true,
    },
    {
        ...
        currentState: fhir_domain_1.CardiovascularVisitState.PHYSICIAN_WITH_PATIENT,
        priority: fhir_domain_1.VisitPriority.HIGH,
...
const mockRooms = [
    {
        ...
        roomType: fhir_domain_1.RoomType.WAITING_ROOM,
        capacity: 20,
        currentOccupancy: 5,
    ...
    },
    {
        ...
        roomType: fhir_domain_1.RoomType.CHECK_IN_DESK,
        capacity: 1,
        currentOccupancy: 0,
        occupantNames: [],
        isAvailable: true,
    ...
    },
    {
        ...
        roomType: fhir_domain_1.RoomType.EXAM_ROOM,
        capacity: 2,
        currentOccupancy: 2,
    ...
    },
    {
        ...
        tenantId: 'default',
        roomNumber: 'ECG Room',
        roomType: fhir_domain_1.RoomType.ECG_ROOM,
        capacity: 1,
        currentOccupancy: 1,
    ...
    },
    {
        ...
        tenantId: 'default',
        roomNumber: 'Echo Lab',
        roomType: fhir_domain_1.RoomType.ECHO_LAB,
        capacity: 2,
        currentOccupancy: 0,
        occupantNames: [],
        isAvailable: true,
...
const mockQueueItems = [
    {
        id: 'queue-item-001',
        queueName: fhir_domain_1.QueueName.NURSING_ASSESSMENT,
        visitId: 'visit-002',
        patientName: 'Mary Johnson',
        priority: fhir_domain_1.VisitPriority.NORMAL,
        status: fhir_domain_1.QueueItemStatus.IN_PROGRESS,
    ...
    {
        id: 'queue-item-002',
        queueName: fhir_domain_1.QueueName.PHYSICIAN_CONSULT,
        visitId: 'visit-005',
        patientName: 'William Brown',
        priority: fhir_domain_1.VisitPriority.HIGH,
        status: fhir_domain_1.QueueItemStatus.IN_PROGRESS,
    ...
    {
        id: 'queue-item-003',
        queueName: fhir_domain_1.QueueName.CHECK_IN,
        visitId: 'visit-001',
        patientName: 'John Smith',
        priority: fhir_domain_1.VisitPriority.URGENT,
        status: fhir_domain_1.QueueItemStatus.PENDING,
        createdAt: new Date(Date.now() - 3 * 60 * 1000).toISOString(),
        estimatedDurationMinutes: 5,
    },
    {
        id: 'queue-item-004',
        queueName: fhir_domain_1.QueueName.PROCEDURE_ECHO,
        visitId: 'visit-003',
        patientName: 'Robert Davis',
        priority: fhir_domain_1.VisitPriority.NORMAL,
        status: fhir_domain_1.QueueItemStatus.PENDING,
...
exports.mockQueueItems = mockQueueItems;
/**
...
async function fetchDashboard(tenantId = 'default') {
    ...
    const visitsByState = {};
    for (const state of Object.values(fhir_domain_1.CardiovascularVisitState)) {
        visitsByState[state] = mockVisits.filter((v) => v.currentState === state).length;
    }
    const visitsByPriority = {};
    for (const priority of Object.values(fhir_domain_1.VisitPriority)) {
        if (typeof priority === 'number') {
            visitsByPriority[priority] = mockVisits.filter((v) => v.priority === priority).length;
        }
    }
    const urgent = mockVisits.filter((v) => v.priority === fhir_domain_1.VisitPriority.URGENT);
    const recentDischarges = mockVisits.filter((v) => v.currentState === fhir_domain_1.CardiovascularVisitState.DISCHARGED);
    const queueStats = [
        {
            queueName: fhir_domain_1.QueueName.CHECK_IN,
            pendingCount: 1,
    ...
    const dashboard = {
        ...
        rooms: {
            ...
            byType: {
                [fhir_domain_1.RoomType.WAITING_ROOM]: mockRooms.filter((r) => r.roomType === fhir_domain_1.RoomType.WAITING_ROOM),
                [fhir_domain_1.RoomType.CHECK_IN_DESK]: mockRooms.filter((r) => r.roomType === fhir_domain_1.RoomType.CHECK_IN_DESK),
                [fhir_domain_1.RoomType.EXAM_ROOM]: mockRooms.filter((r) => r.roomType === fhir_domain_1.RoomType.EXAM_ROOM),
                [fhir_domain_1.RoomType.ECG_ROOM]: mockRooms.filter((r) => r.roomType === fhir_domain_1.RoomType.ECG_ROOM),
                [fhir_domain_1.RoomType.ECHO_LAB]: mockRooms.filter((r) => r.roomType === fhir_domain_1.RoomType.ECHO_LAB),
                [fhir_domain_1.RoomType.STRESS_TEST_LAB]: [],
                [fhir_domain_1.RoomType.HOLTER_ROOM]: [],
                [fhir_domain_1.RoomType.CONSULT_ROOM]: [],
                [fhir_domain_1.RoomType.BLOOD_DRAW]: [],
                [fhir_domain_1.RoomType.CHECKOUT_DESK]: [],
                [fhir_domain_1.RoomType.BILLING_OFFICE]: [],
            },
        },
        recentEvents: [],
        staffWorkload: [],
...
async function claimQueueItem(itemId, userId) {
    ...
    if (item) {
        item.status = fhir_domain_1.QueueItemStatus.IN_PROGRESS;
...
async function completeQueueItem(itemId, notes) {
    ...
    const item = mockQueueItems.find((i) => i.id === itemId);
    if (item) {
        item.status = fhir_domain_1.QueueItemStatus.COMPLETED;
